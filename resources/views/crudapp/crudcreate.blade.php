...
<div class="container-fluid edit">
    ...
    <form action="{{ url('/crudapp/create_part') }}" method="POST">
        @csrf
        @method('PUT')
        <section><h1>Part Number - </h1>
            <input type="text" name="part_num" value="" class="form-control">
        </section>

        <section><h1>Description - </h1>
            <input type="text" name="part_description" value="" class="form-control">
        </section>
